...
const ProductDisplay = () => {
  ...
  useEffect(() => {
    const getProductDetails = async () => {
      await axios.post("https://mernamsproject.onrender.com/specificProduct", { id: itemId })
        .then((response) => {
      ...
      await axios.post("https://mernamsproject.onrender.com/isWishlist", { id: itemId, jwtToken: cookies.get('token') })
        .then((response) => {
          // console.log(response.data)
      ...
      await axios.post("https://mernamsproject.onrender.com/getProductCart", { id: itemId, jwtToken: cookies.get('token') })
        .then((response) => {
  ...
  const makeWishlist = async () => {
    if (cookies.get('token') === undefined) {
      ...
      await axios.post("https://mernamsproject.onrender.com/makeWishlist", { id: itemId, jwtToken: cookies.get('token') })
        .then((response) => {
          console.log(response.data)
          setIsWishlist(response.data)
        })
  ...
  const addToCart = () => {
    if (cookies.get('token') === undefined) {
      ...
      if (sizeClick === -1) {
        ...
        axios.post('https://mernamsproject.onrender.com/addProductToCart', { size: sizeClick, userId: usercart.userId, itemId: itemId })
          .then((response) => {
            setUsercart(prevusercart => ({
              ...prevusercart,
              usercartItems: response.data.usercartItems
      ...
      axios.post('https://mernamsproject.onrender.com/addProductToCart', { userId: usercart.userId, itemId: itemId })
        .then((response) => {
          setUsercart(prevusercart => ({
            ...prevusercart,
            usercartItems: response.data.usercartItems
            ...
            <div style={{ width: "100%", height: "100%", display: "flex", justifyContent: "space-between" }}>
              ...
              <div style={{ width: "65%", height: "100%" }}>
                <div style={{ padding: "2%" }}>
                  ...
                  <CardContent>
                    <p style={{ fontWeight: "bold" }}>Select your Quantity</p>
