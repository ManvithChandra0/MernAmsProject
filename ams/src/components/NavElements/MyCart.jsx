...
const MyCart = () => {
  ...
  useEffect(() => {
    const getAll = async () => {
      await axios.post("https://mernamsproject.onrender.com/getCartInfo", { jwtToken: cookies.get('token') }).then((response) => {
  ...
  const saveQuantity = (index, id, operation) => {
    const getCart = async () => {
      await axios.post("https://mernamsproject.onrender.com/updateQuantity", { userId: usercart.userId, itemId: id, updatedQuantity: operation, index: index }).then((response) => {
        setUsercart(prevUsercart => {
  ...
  const removeItem = (itemId, selectedSize) => {
    const getCart = async () => {
      await axios.post("https://mernamsproject.onrender.com/removeItem", { userId: usercart.userId, itemId: itemId, size: selectedSize }).then((response) => {
        setUsercart(prevusercart => ({
          ...prevusercart,
          usercartItems: response.data.usercartItems,
        }));
